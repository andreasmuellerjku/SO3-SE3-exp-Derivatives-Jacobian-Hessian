...
SE3Exp::usage = "SE3Exp[X, eps] returns returns the SE(3) matrix exp(X) for twist X, with small-angle threshold eps ([1] eq. (17)).";

SE3dexp::usage = "SE3dexp[X, eps:-1] returns right-trivialized differential dexp of exp in terms of the adjoint representation ([1] eq. (21)).";
SE3dexpInv::usage = "SE3dexpInv[X, eps:-1] returns right-trivialized differential dexp^-1 of exp^-1 in terms of the adjoint representation ([1] eq. (22)).";

SE3Ddexp::usage = "SE3Ddexp[X, U, eps:-1] returns the directional derivative of dexp at X along Y ([1] eq. (28)).";
SE3DdexpInv::usage = "SE3DdexpInv[X, U, eps:-1] returns the directional derivative of dexp^-1 at X along Y ([1] eq. (29)).";

SE3D2dexp::usage = "SE3D2dexp[X, U, S, eps:-1] returns the second directional derivative of dexp at X along Y, S ([1] eq. (39)).";
SE3D2dexpInv::usage = "SE3D2dexpInv[X, U,S,  eps:-1] returns the second directional derivative of dexp^-1 at X along Y, S ([1] eq. (39)).";

(* Jacobians with respect to X applied to Z *)
SE3dexpJac::usage = "SE3dexpJac[X, Z, eps:-1] returns the Jacobian (w.r.t X) of dexp[X]·Z ([1] eq. (36)).";
SE3dexpInvJac::usage = "SE3dexpInvJac[X, Z, eps:-1] returns the Jacobian (w.r.t X) of dexp[X]^{-1}·Z ([1] eq. (37)).";
SE3dexpJacTranspose::usage = "SE3dexpJacTranspose[X, Z, eps:-1] returns the Jacobian of dexp[X]^T·Z ([1] eq. (38)).";

(* Hessians (Q^T · dexp · Z and Q^T · dexp^{-1} · Z) *)
SE3dexpHessian::usage = "SE3dexpHessian[X, Q, Z, eps:-1] returns the Hessian of Q^T·dexp[X]·Z ([1] eq. (47-50)).";
SE3dexpInvHessian::usage = "SE3dexpInvHessian[X, Q, Z] returns the Hessian of Q^T·dexp[X]^{-1}·Z ([1] eq. (47-50)).";

(* Truncated series approximations *)
SE3dexpOrder1::usage = "SE3dexpOrder1[X] first-order approximation of dexp ([1] (18)).";
SE3dexpOrder2::usage = "SE3dexpOrder2[X] second-order approximation of dexp ([1] (18)).";
SE3dexpOrder3::usage = "SE3dexpOrder3[X] third-order approximation of dexp ([1] (18)).";
SE3dexpOrder4::usage = "SE3dexpOrder4[X] fourth-order approximation of dexp ([1] (18)).";

SE3dexpInvOrder1::usage = "SE3dexpInvOrder1[X] first-order approximation of dexp^{-1} ([1] (18)).";
SE3dexpInvOrder2::usage = "SE3dexpInvOrder2[X] second-order approximation of dexp^{-1} ([1] (18)).";
SE3dexpInvOrder3::usage = "SE3dexpInvOrder3[X] third-order approximation of dexp^{-1} ([1] (18)).";
SE3dexpInvOrder4::usage = "SE3dexpInvOrder4[X] fourth-order approximation of dexp^{-1} ([1] (18)).";

SE3DdexpOrder0::usage = "SE3DdexpOrder0[X, U] zeroth-order approximation of D(dexp) ([1] Table 2).";
SE3DdexpOrder1::usage = "SE3DdexpOrder1[X, U] first-order approximation of D(dexp) ([1] Table 2).";
SE3DdexpOrder2::usage = "SE3DdexpOrder2[X, U] second-order approximation of D(dexp) ([1] Table 2).";
SE3DdexpOrder3::usage = "SE3DdexpOrder3[X, U] third-order approximation of D(dexp) ([1] Table 2).";

SE3DdexpInvOrder0::usage = "SE3DdexpInvOrder0[X, U] zeroth-order approximation of D(dexp^{-1} ([1] Table 3)).";
SE3DdexpInvOrder1::usage = "SE3DdexpInvOrder1[X, U] first-order approximation of D(dexp^{-1}) ([1] Table 3).";
SE3DdexpInvOrder2::usage = "SE3DdexpInvOrder2[X, U] second-order approximation of D(dexp^{-1} ([1] Table 3)).";
SE3DdexpInvOrder3::usage = "SE3DdexpInvOrder3[X, U] third-order approximation of D(dexp^{-1} ([1] Table 3)).";

SE3D2dexpOrder0::usage = "SE3D2dexpOrder0[X, U, S] zeroth-order approximation of D^2(dexp) ([1] Table 4).";
SE3D2dexpOrder1::usage = "SE3D2dexpOrder1[X, U, S] first-order approximation of D^2(dexp) ([1] Table 4).";
SE3D2dexpOrder2::usage = "SE3D2dexpOrder2[X, U, S] second-order approximation of D^2(dexp) ([1] Table 4).";

SE3D2dexpInvOrder0::usage = "SE3D2dexpInvOrder0[X, U, S] zeroth-order approximation of D^2(dexp^{-1}) ([1] Table 5).";
SE3D2dexpInvOrder2::usage = "SE3D2dexpInvOrder2[X, U, S] second-order approximation of D^2(dexp^{-1}) ([1] Table 5).";

SE3dexpJacOrder0::usage = "SE3dexpJacOrder0[X, Z] zeroth-order approximation of Jacobian of dexp·Z ([1] Table 2).";
SE3dexpJacOrder1::usage = "SE3dexpJacOrder1[X, Z] first-order approximation of Jacobian of dexp·Z ([1] Table 2).";
SE3dexpJacOrder2::usage = "SE3dexpJacOrder2[X, Z] second-order approximation of Jacobian of dexp·Z ([1] Table 2).";

SE3dexpHessianOrder0::usage = "SE3dexpHessianOrder0[X, Q, Z] zeroth-order approximation of Hessian of Q^T·dexp·Z ([1] eq. (61), Table 6).";
SE3dexpHessianOrder1::usage = "SE3dexpHessianOrder1[X, Q, Z] first-order approximation of Hessian of Q^T·dexp·Z ([1] eq. (61), Table 6).";
SE3dexpHessianOrder2::usage = "SE3dexpHessianOrder2[X, Q, Z] second-order approximation of Hessian of Q^T·dexp·Z ([1] eq. (61), Table 6).";
...
SE3dexpJac[X_, Z_, eps_:SE3EPS] := Module[{x, Z1, Z2, Z3, Z4}, 
   ...
   Z1 = P[X, 1] . Z; 
   Z2 = P[X, 2] . Z; 
   Z3 = P[X, 3] . Z; Z4 = P[X, 4] . Z; If[x . x < eps, Return[(-1/2)*SE3adMatrix[Z]]]; 
