...
SO3Exp::usage = "SO3Exp[x] returns the SO(3) rotation matrix exp(x) using the sinc-based closed form ([2] eq. (2.8)).";
SO3Log::usage = "SO3Log[R, eps] returns the logarithm vector x such that R = exp(x). Small-angle threshold eps.";
SO3dexp::usage = "SO3dexp[x, eps] returns the right-trivialized differential dexp of exp at x in so(3) ([2] eq. (2.13)).";
SO3dexpInv::usage = "SO3dexpInv[x, eps] returns the inverse of dexp at x in so(3) ([2] eq. (2.16)).";
SO3Ddexp::usage = "SO3Ddexp[x, y, eps] returns the directional derivative D(dexp)_x(y) of dexp at x along y ([2] eq. (2.33)).";
SO3DdexpInv::usage = "SO3DdexpInv[x, y, eps] returns directional derivative D(dexp^-1)_x(y) of dexp^-1 at x along y ([2] eq. (2.40)).";
SO3D2dexp::usage = "SO3D2dexp[x, y, u, v, eps] returns the directional derivative of Ddexp(X):=D_x(dexp)(y) at X=(x,y) along U=(u,v) ([2] eq. (2.49)).";
SO3D2dexpInv::usage = "SO3D2dexpInv[x, y, u, v, eps] returns the directional derivative of Ddexp^-1(X):=D_x(dexp^-1)(y) at X=(x,y) along U=(u,v) ([2] eq. (2.53)).";
...
(* SO3Ddexp - directional derivative of dexp (1st directional derivative)
...
(* SO3D2dexp - second derivative of dexp.
